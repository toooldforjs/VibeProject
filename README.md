...
**Для понимания приниципа работы**
...
Ответ GigaChat показывется в моальном окне с возможностью скопировать его (текст или MD) или сохранить в комментариях к задаче.
