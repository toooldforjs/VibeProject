...
После запуска проекта нужно перейти в настройки в меню профиля и заполнить там параметры подключения к Jira, Confluence, GigaChat + параметры запросов к GigaChat.
